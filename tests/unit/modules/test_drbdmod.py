...
'''
        ...
        # Test 2: Test _is_no_backing_dev_request() return no "res"
        fake = {}
        fake['stdout'] = '''
[
{
...
'''
        ...
        mock_cmd = MagicMock(side_effect=[fake, fake, fake1])

        with patch.dict(drbd.__salt__, {'cmd.run_all': mock_cmd}):
            assert not drbd.check_sync_status('shanghai')
            mock_cmd.assert_called_with('drbdsetup status --json shanghai')

        # Test 3: Test _is_no_backing_dev_request() have unfinished requrests
        fake = {}
        fake['stdout'] = '''
[
{
...
'''
        ...
        # Test 4: Test _is_no_backing_dev_request() all requrests finished
        fake = {}
        fake['stdout'] = '''
[
{
